...
export const waxTreeActions={
  ...
  findBcMatch,findTrack,findTrackContext:findTrackAndNode,getAvatarUrl,getBranch,getExploreTargets,getLevelFromCount,getNode,getProgressToNext,getRelatedView,getTrackVideo,
