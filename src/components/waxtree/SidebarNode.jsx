  ...
  return (
    <>
      ...
      >
        ...
        <span className="flex size-4 shrink-0 items-center justify-center text-muted-foreground/70">{node.type === 'label' || node.type === 'bcLabel' ? <LabelIcon className="size-3.5" /> : node.type === 'genreYear' ? <Tags className="size-3.5" /> : <ArtistIcon className="size-3.5" />}</span>
